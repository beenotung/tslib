...
/* CurryF<> */
export type CurryF1<T1,R> = F1<T1,R>
  ;
export type CurryF2<T1,T2,R> = F2<T1,T2,R>
    | F1<T1,CurryF1<T2, R>>
  ;
export type CurryF3<T1,T2,T3,R> = F3<T1,T2,T3,R>
    | F1<T1,CurryF2<T2,T3, R>>
    | F2<T1,T2,CurryF1<T3, R>>
  ;
export type CurryF4<T1,T2,T3,T4,R> = F4<T1,T2,T3,T4,R>
    | F1<T1,CurryF3<T2,T3,T4, R>>
    | F2<T1,T2,CurryF2<T3,T4, R>>
    | F3<T1,T2,T3,CurryF1<T4, R>>
  ;
export type CurryF5<T1,T2,T3,T4,T5,R> = F5<T1,T2,T3,T4,T5,R>
    | F1<T1,CurryF4<T2,T3,T4,T5, R>>
    | F2<T1,T2,CurryF3<T3,T4,T5, R>>
    | F3<T1,T2,T3,CurryF2<T4,T5, R>>
    | F4<T1,T2,T3,T4,CurryF1<T5, R>>
  ;
export type CurryF6<T1,T2,T3,T4,T5,T6,R> = F6<T1,T2,T3,T4,T5,T6,R>
  ...
  ;
export type CurryF7<T1,T2,T3,T4,T5,T6,T7,R> = F7<T1,T2,T3,T4,T5,T6,T7,R>
  ...
  ;
export type CurryF8<T1,T2,T3,T4,T5,T6,T7,T8,R> = F8<T1,T2,T3,T4,T5,T6,T7,T8,R>
  ...
  ;
export type CurryF9<T1,T2,T3,T4,T5,T6,T7,T8,T9,R> = F9<T1,T2,T3,T4,T5,T6,T7,T8,T9,R>
  ...
  ;
export type CurryF10<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,R> = F10<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,R>
  ...
  ;
export type CurryF11<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,R> = F11<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,R>
  ...
  ;
export type CurryF12<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,R> = F12<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,R>
